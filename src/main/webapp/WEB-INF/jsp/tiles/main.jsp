            ...
            <div class="visualRoll">
                ...
                <div class="rollbtnArea">
                    <ul class="rollingbtn">
                        ...
                        <li class="rollstop"><a href="#" onclick="return false" class="stop"><img src="<c:url value='/'/>home/img/btn_roll_stop.png" alt="멈춤" /></a></li>
                        <li class="rollplay"><a href="#" onclick="return false" class="play"><img src="<c:url value='/'/>home/img/btn_roll_play.png" alt="재생" /></a></li>
                    </ul>
                </div><!-- //rollbtnArea -->
